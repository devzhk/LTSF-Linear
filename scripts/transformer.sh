...
python3 run_longExp.py --is_training 1 --model_id Train4Test1 --model Transformer --learning_rate 0.00002 # train
python3 run_longExp.py --is_training 0 --model_id Train4Test1 --model Transformer --do_predict --is_training 0 --data_path Subject_5-cleaned-VR.csv